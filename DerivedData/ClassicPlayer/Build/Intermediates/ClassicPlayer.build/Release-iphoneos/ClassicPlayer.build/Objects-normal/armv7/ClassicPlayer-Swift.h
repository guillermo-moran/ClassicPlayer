...
@interface AlbumsMenuVC : UIViewController <UITableViewDelegate, UITableViewDataSource>
...
@interface ArtistsMenuVC : UIViewController <UITableViewDelegate, UITableViewDataSource>
...
@interface MusicMenuVC : UIViewController <UITableViewDataSource, UITableViewDelegate>
@property (nonatomic, readonly, copy) NSArray<NSString *> * _Nonnull menuItems;
@property (nonatomic, copy) NSIndexPath * _Nonnull currentIndexPath;
- (void)viewWillAppear:(BOOL)animated;
- (void)viewWillDisappear:(BOOL)animated;
...
@interface PlaylistsMenuVC : UIViewController <UITableViewDelegate, UITableViewDataSource>
...
@interface SongListMenuVC : UIViewController <UITableViewDelegate, UITableViewDataSource>
